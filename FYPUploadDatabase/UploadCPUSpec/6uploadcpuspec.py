...
# item = response['Item']
# print(item)
###delcare a custom exception for customized error catching
class MyException(Exception):
    pass

###declare a CPU dictionary for uploading data into DynamoDB
class CPU(object):
...
###declare a information column in to decimal type
...
###search through the scrapped CPU information folder to get
###return a list of Grapped CPU Data
...
###Read the txt file on FYPScrapper folder and upload data into DynamoDB
