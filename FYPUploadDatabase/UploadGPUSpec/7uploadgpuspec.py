...
# item = response['Item']
# print(item)
###declare a python dictionary to store all information about GPU
class GPU(object):
...
###Search through a specified folder to get all CPU Data in that directory
###Return a list of GPU Data
...
###read all GPU data in "FYPScrapper" and upload the data into DynamoDB
