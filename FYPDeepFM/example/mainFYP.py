...
def _run_base_model_dfm(dfTrain, dfTest, folds, dfm_params,save_path:str):
    ...
    for i, (train_idx, valid_idx) in enumerate(folds):
        ...
        # print('saving')
        dfm.saver.save(dfm.sess, save_path, global_step=dfm_params["epoch"]*(i+1))
...
# y_train_dfm, y_test_dfm,dfm_dfm = _run_base_model_dfm(dfTrain, dfTest, folds, dfm_params,"save/dfm/temp")
...
y_train_dnn, y_test_dnn,dfm_dnn = _run_base_model_dfm(dfTrain, dfTest, folds, dnn_params,"save/dnn/temp")
